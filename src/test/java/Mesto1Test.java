...
public class Mesto1Test {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MWUxNDg1MTQ4MDljMTAwMzZlOTMxMDMiLCJpYXQiOjE2NTIzNTUyOTIsImV4cCI6MTY1Mjk2MDA5Mn0.ss8az184l9qUpu0kwL48OMtqtilNBfHU1064KCZqlHA";
    ...
    public void addNewPhoto() {
        given()
                ...
                .then().statusCode(400); // Проверяем код ответа
    }
